      ...
      <article data-page="about">
        <header>
          ...
          >
            ...
            >
              Explore the open source projects I've worked on so far
            </h4>
          </div>
        </header>
        <section>
          <div>
            <div
              class="grid grid-cols-1 gap-4 pb-10 md:grid-cols-3 md:gap-3 xl:grid-cols-3 xl:gap-3 2xl:gap-5 fade-zoom-in"
            >
